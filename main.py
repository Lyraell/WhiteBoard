...
tk.Label(root, image=color_box, bg='#f2f3f5').place(x=10,y=20)

eraser=PhotoImage(file='eraser.png')
tk.Button(root,image=eraser,bg='#f2f3f5',command=new_canvas).place(x=30,y=400)

importimage=PhotoImage(file='addimage.png')
tk.Button(root,image=importimage,bg='#f2f3f5', command=insertimage).place(x=30,y=450)
...
##main screen
canvas = tk.Canvas(root, width=930, height=500, bg='white', cursor='hand2' )
